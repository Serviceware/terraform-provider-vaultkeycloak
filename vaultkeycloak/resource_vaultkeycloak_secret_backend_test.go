...
func TestAccVaultKeycloakBasicIgnoreConnect(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckVaultKeycloakSecretBackendConfigBasicIgnoreConnect("master", "vault", "thisisnottheclientsecret"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckVaultKeycloakSecretBackendExists("vaultkeycloak_secret_backend.test_backend"),
					resource.TestCheckResourceAttr("vaultkeycloak_secret_backend.test_backend", "client_id", "vault"),
				),
...
func testAccCheckVaultKeycloakSecretBackendConfigBasicIgnoreConnect(realm, client_id, client_secret string) string {
	return fmt.Sprintf(`
	resource "vaultkeycloak_secret_backend" "test_backend" {
		client_id     = "%s"
		client_secret = "%s"
